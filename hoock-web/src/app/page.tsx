...
const SectionSkeleton = ({ color = "border-t-[#CBA68B]", label }: { color?: string; label: string }) => (
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <Suspense fallback={<SectionSkeleton color="border-t-[#CBA68B]" label="Loading Services..." />}>
        <ServicesSection />
      </Suspense>
